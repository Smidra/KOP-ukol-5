...
x =           [0.1        0.3            0.5          0.7            1    ];
dynMAXlight = [96116     100756     98110     95340      95275              ];
dynAVGlight = [78105     77694      77463     78018      77197              ];
dynMAXheavy = [98246     105286     101850    96185      97766  ];
dynAVGheavy = [77614     78478      77889     79056      78291  ];


plot(x, dynMAXlight,  '-x', 'LineWidth', width ,'color', [0.4660 0.6740 0.1880]); hold on
plot(x, dynAVGlight,  '-o', 'LineWidth', width ,'color', [0.4660 0.6740 0.1880]); hold on
plot(x, dynMAXheavy,  '-x', 'LineWidth', width ,'color', [0.4940 0.1840 0.5560]); hold on
plot(x, dynAVGheavy,  '-o', 'LineWidth', width ,'color', [0.4940 0.1840 0.5560]); hold on

legend('light dynamic max', 'light dynamic avg', 'heavy dynamic max', 'heavy dynamic avg')
ylim([0 120000])
